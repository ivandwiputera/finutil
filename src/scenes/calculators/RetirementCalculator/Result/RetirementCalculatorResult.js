...
const RetirementCalculatorResult = (props) => {
  ...
  return ( 
    <div className="retirement-calculator-result-container">
      <div className="font-size-body font-weight-medium">{localise(Copy.retirementCalculatorResultTitle)}</div>
      ...
      <div className="mt-150 font-size-small">{localise(Copy.retirementCalculatorResultWithdrawalAmountLabel)}</div>
