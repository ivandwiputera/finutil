...
const LocaliseTranslation = {
  ...
  emergencyFundsCalculatorFormErrorMonthlyExpensesNegative: "Monthly expenses cannot be empty.",
  ...
  goalSettingCalculatorFormInflationHelperText: "This is estimated inflation rate of your goal. If you don't want to include inflation, you can enter as '0'",
  ...
  goalSettingCalculatorResultDescription: "It is important to note that consistency is the key to achieve your goals, especially the big one.\n\nIf the amount mentioned above is too much for you, you can extend the duration and give more time, or maybe readjust your goals.",
